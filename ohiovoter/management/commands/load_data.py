...
class Command(BaseCommand):
    def handle(self, **kwargs):
        ...
        if answer == 'y':
            ...
            # keep this state outside of the loop since it exists between county files
            ...
            for county in COUNTIES:
                ...
                with tempfile.TemporaryDirectory() as tmpdirname:
                    ...
                    county_filename = '{}/{}.TXT'.format(tmpdirname, county)
                    ...
                    with open(county_filename, encoding='utf-8') as input_file:
                        ...
                        e_start = time.time()
                        print('Starting to insert Elections')
                        ...
                        e_end = time.time()
                        print('Done inserting Elections')
                        print('Writing Elections took: {}'.format(e_end-e_start))
