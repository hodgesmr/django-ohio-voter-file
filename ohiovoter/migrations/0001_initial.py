    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(choices=[(1, b'GENERAL'), (2, b'PRIMARY'), (3, b'SPECIAL')], db_index=True)),
                ('date', models.DateField(db_index=True)),
                ('party', models.CharField(choices=[(b'C', b'CONSTITUTION'), (b'D', b'DEMOCRAT'), (b'E', b'REFORM'), (b'G', b'GREEN'), (b'L', b'LIBERTARIAN'), (b'N', b'NATURAL_LAW'), (b'R', b'REPUBLICAN'), (b'S', b'SOCIALIST'), (b'X', b'N/A')], db_index=True, max_length=512)),
            ],
            options={
                'ordering': ('-date', 'party'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('election', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ohiovoter.Election')),
            ],
        ),
        migrations.CreateModel(
            name='Voter',
            fields=[
                ...
                ('elections', models.ManyToManyField(through='ohiovoter.Participation', to='ohiovoter.Election')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='voter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ohiovoter.Voter'),
        ),
        migrations.AddField(
            model_name='election',
            name='voters',
            field=models.ManyToManyField(through='ohiovoter.Participation', to='ohiovoter.Voter'),
        ),
